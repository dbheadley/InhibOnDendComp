""" Binned dendritic events with respect to an ongoing rhythm
...
def bin_rhythmic_files(dend_fname, rhym_ser, step_ser, win_ser, bin_num):
    """
    ...
    dend_seg = bin_rhym_dendevt(dend_seg, rhym_ser, bin_num=bin_num)
