""" Creates numpy array from an H5 file containing auxiliary spike events
...
def load_spike_aux_h5(fpath):
    ...
    spk_t : numpy array of integers
        simulation time steps where an a presynaptic spike occurred
    ...
    spk_t = np.array(spikes["spikes"]["exc_stim_aux"]["timestamps"])
